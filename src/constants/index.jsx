...
import logisticsIcon1 from "../assets/services/icon-1.png";
import logisticsIcon2 from "../assets/services/icon-2.png";
import logisticsIcon3 from "../assets/services/icon-3.png";
import logisticsIcon4 from "../assets/services/icon-4.png";
import logisticsIcon5 from "../assets/services/icon-5.png";
import logisticsIcon6 from "../assets/services/icon-6.png";

import dashboardIcon1 from "../assets/dashboard/image-1.png";
import dashboardIcon2 from "../assets/dashboard/image-2.png";

import m1 from "../assets/testimonials/m-1.jpg";
import m2 from "../assets/testimonials/m-2.jpg";
import m3 from "../assets/testimonials/m-3.jpg";
import m4 from "../assets/testimonials/m-4.jpg";
import m5 from "../assets/testimonials/m-5.png";
import m6 from "../assets/testimonials/m-6.png";
import f1 from "../assets/testimonials/f-1.jpg";
import f2 from "../assets/testimonials/f-2.jpg";
import f3 from "../assets/testimonials/f-3.jpg";
import f4 from "../assets/testimonials/f-4.png";
...
export const services = [
  {
    ...
    text: "Reliable and efficient transportation solutions for goods of all sizes, ensuring timely deliveries worldwide.",
    iconUrl: logisticsIcon1,
  },
  {
    id: "1",
    title: "Warehousing & Storage",
    text: "Secure and scalable warehousing solutions for businesses of all sizes, with real-time inventory tracking.",
    iconUrl: logisticsIcon2,
  },
  {
    id: "2",
    title: "Last-Mile Delivery",
    text: "Fast and reliable last-mile delivery services to get your products into your customers' hands efficiently.",
    iconUrl: logisticsIcon3,
  },
  {
    id: "3",
    title: "Supply Chain Management",
    text: "Comprehensive supply chain solutions that optimize logistics processes and reduce operational costs.",
    iconUrl: logisticsIcon4,
  },
  {
    id: "4",
    title: "Customs Clearance",
    text: "Seamless customs clearance services to ensure smooth and hassle-free international shipments.",
    iconUrl: logisticsIcon5,
  },
  {
    id: "5",
    title: "Cold Chain Logistics",
    text: "Specialized temperature-controlled transport and storage solutions for perishable goods and pharmaceuticals.",
    iconUrl: logisticsIcon6,
  },
];

export const dashboardFeatures = [
  { id: "0", title: "Real-Time Shipment Tracking", icon: dashboardIcon1 },
  { id: "1", title: "Performance Analytics & Reports", icon: dashboardIcon2 },
];
...
export const testimonials = [
  {
    ...
    image: m1,
    comment:
      "Exceptional service! Our shipments always arrive on time, and the tracking system keeps us updated every step of the way.",
  },
  {
    id: "1",
    name: "Sarah Smith",
    image: f1,
    comment:
      "Reliable and professional! Their logistics solutions have helped us streamline our supply chain and reduce costs.",
  },
  {
    id: "2",
    ...
    image: m2,
    comment:
      "We’ve worked with many logistics providers, but this company stands out for their efficiency and excellent customer support.",
  },
  {
    id: "3",
    name: "Emily Brown",
    image: f2,
    comment:
      "Fast, secure, and hassle-free shipping! We never have to worry about our deliveries anymore.",
  },
  {
    id: "4",
    name: "David Wilson",
    image: m3,
    comment:
      "Their real-time tracking and seamless communication make logistics management so much easier for our business.",
  },
  {
    id: "5",
    ...
    image: f3,
    comment:
      "Highly recommend! They handle our international shipments with precision and care, ensuring smooth customs clearance every time.",
  },
  {
    id: "6",
    name: "James Anderson",
    image: m4,
    comment:
      "The team goes above and beyond to make sure our deliveries are handled with professionalism and speed.",
  },
  {
    id: "7",
    name: "Sophia Taylor",
    image: f4,
    comment:
      "Best logistics partner we’ve had! Their technology-driven approach helps us stay ahead in the industry.",
  },
  {
    id: "8",
    name: "William Harris",
